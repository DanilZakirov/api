...
`GET /employers/blacklisted` возвращает [подмножество работодателей](https://api.hh.ru/openapi/redoc#tag/Informaciya-o-rabotodatele/paths/~1employers/get), скрытых пользователем.
