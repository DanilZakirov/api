...
employer | object or null | Brief description of an employer. See field description in [employer information](https://api.hh.ru/openapi/en/redoc#tag/Employer-info/paths/~1employers~1%7Bemployer_id%7D/get). null for anonymous vacancy
...
* `employer_id` – a [company](https://api.hh.ru/openapi/en/redoc#tag/Employer-info) identifier.
  Several values can be indicated.
