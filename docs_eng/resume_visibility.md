...
The visibility list contains employer IDs (see the [company search](https://api.hh.ru/openapi/en/redoc#tag/Employer-info/paths/~1employers/get) and [getting information about a company](https://api.hh.ru/openapi/en/redoc#tag/Employer-info/paths/~1employers~1%7Bemployer_id%7D/get)).
